...
- 锁定 revision：`b570acead5e27006cb41ab5ff7443c8797b3b8e5`。
...
独立 `.app` 的 `Contents/Resources` 中随附完整许可证文本、`Package.resolved`、精确源码获取说明 `THIRD_PARTY_SOURCE.md`，以及锁定 revision 的完整 CXXTagLib 源码归档。
